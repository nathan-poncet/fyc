defmodule Connect4.Games.GameTest do
  ...
  test "move" do
    ...
    assert %{board: ^expected_board} = Connect4.Games.Game.move(game, player, col_index)
  end
  ...
  test "move with wrong column index" do
    ...
    assert_raise FunctionClauseError, fn -> Connect4.Games.Game.move(game, player, col_index) end
  end
end
